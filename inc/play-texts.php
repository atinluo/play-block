...
function play_get_text( $str, $echo = false ) {
    $texts = array(
        ...
        'song'                   => esc_html__( 'Song', 'play-block' ),
        'songs'                  => esc_html__( 'Songs', 'play-block' ),
        'album'                  => esc_html__( 'Album', 'play-block' ),
        'albums'                 => esc_html__( 'Albums', 'play-block' ),
        'series'                 => esc_html__( 'Series', 'play-block' ),
        'short'                  => esc_html__( 'Short', 'play-block' ),
        'shorts'                 => esc_html__( 'Shorts', 'play-block' ),
        'video'                  => esc_html__( 'Video', 'play-block' ),
        'videos'                 => esc_html__( 'Videos', 'play-block' ),
        'tvshow'                 => esc_html__( 'TV Show', 'play-block' ),
        'tvshows'                => esc_html__( 'TV Shows', 'play-block' ),
        'movie'                  => esc_html__( 'Movie', 'play-block' ),
        'movies'                 => esc_html__( 'Movies', 'play-block' ),
        'podcast'                => esc_html__( 'Podcast', 'play-block' ),
        'podcasts'               => esc_html__( 'Podcasts', 'play-block' ),
        'episode'                => esc_html__( 'Episode', 'play-block' ),
        'episodes'               => esc_html__( 'Episodes', 'play-block' ),
        'radio'                  => esc_html__( 'Radio', 'play-block' ),
        'radios'                 => esc_html__( 'Radios', 'play-block' ),
        ...
        'spotify'                => esc_html__( 'Spotify', 'play-block' ),
        'apple'                  => esc_html__( 'Apple Music', 'play-block' ),
        'amazon'                 => esc_html__( 'Amazon Music', 'play-block' ),
        'bandcamp'               => esc_html__( 'Bandcamp', 'play-block' ),
        'audiomack'              => esc_html__( 'Audiomack', 'play-block' ),
        ...
        'comma'                  => esc_html__( '(Separate with commas)', 'play-block' ),
        ...
        'show-less'              => esc_html__( 'Show less', 'play-block' ),
